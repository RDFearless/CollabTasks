    ...
    <footer className="bg-gray-800 text-gray-300 py-6 mt-auto">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              <span className="bg-blue-600 text-white p-1 rounded mr-2 text-sm">
                CT
              </span>
              <span className="font-semibold">CollabTasks</span>
            </div>
            <p className="text-sm">
              Task management made simple and collaborative for teams of all
              sizes.
            </p>
          </div>
        ...
        <div className="text-center pt-6 mt-6 border-t border-gray-700">
          <p className="text-sm">
            © {currentYear} CollabTasks. All rights reserved.
          </p>
